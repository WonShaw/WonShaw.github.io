...
* Details Accessed: Passkey public keys generated during passkey registration.
* Source: Generated by the Android system as part of passkey (WebAuthn / FIDO2) credential creation.
* Purpose: Demonstration of passkey-based authentication using local verification only.
* Processing:
  * The app stores the passkey public key locally on the device for demonstration and local verification purposes.
  * The corresponding private key is generated and stored securely by the operating system and is not accessible to the app.
  * No passkey data (public key or private key) is transmitted off the device.
  * The app does not communicate with any remote server for passkey registration or authentication.
  * Users may manually delete stored passkey public keys within the app at any time.
